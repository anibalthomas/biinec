...
@foreach ($posts as $post)
	...
	<li class="portfolio-item">
		...
		<img style="height: 284.967px;"src="/storage/{{ $post->photos->first()->url }}" class="img-responsive" alt="{{$post->excerpt}}">
	...
	<figcaption class="mask">
		...
		<ul class="external">
			...
			<li><a class="fancybox" title="{{$post->title}}" data-fancybox-group="works" href="/storage/{{ $post->photos->first()->url }}"><i class="fa fa-eye"></i></a></li>
